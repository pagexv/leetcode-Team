...
Video link: https://www.youtube.com/watch?v=R58Q0J52qzI
...
The correct solution uses maps
...
Input: hello then convert to map <h,1> <> <e,1> <l,2> <o,1>
...
### [588. Design In-Memory File System](https://leetcode.com/problems/design-in-memory-file-system/) :star: :star:



Design a simulated file system
...
1. Separate Directory and file list
2. Unified directory and file list
...
### [680 Valid Palndrome](https://leetcode.com/problems/valid-palindrome-ii/)
...
Using quick select rather than built in function
